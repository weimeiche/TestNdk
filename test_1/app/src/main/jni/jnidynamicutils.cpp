...
// C++层 native函数
jstring native_hellow(JNIEnv *env, jclass clz){
...
static JNINativeMethod gMethods[] = {{
        "getHelloStringFromJNI", "()Ljava/lang/String;", (void *)native_hellow
                                     }};
...
JNIEXPORT jint JNICALL JNI_OnLoad(JavaVM *jvm, void *reserved){
    ...
    jclass  clazz = env->FindClass("com/navyliu/test_1/JNIDynamicUtils");
    if (clazz == NULL){
        return result;
    }
    // 注册方法
